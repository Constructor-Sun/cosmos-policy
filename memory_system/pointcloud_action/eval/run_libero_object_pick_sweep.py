"""Run a LIBERO-Object Pick sweep against the LIBERO-90 pointcloud_action memory."""
...
MANIFEST = REPO / "skill_memory_test/libero_object/segments_ready_fixed16.json"
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=REPO / "rollouts/libero_object_pick_sweep_results.jsonl")
