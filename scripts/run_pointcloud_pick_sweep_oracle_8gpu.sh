...
OUTPUT=$REPO/rollouts/libero10_pick_sweep_oracle_20_results.jsonl
VIDEO_DIR=$REPO/rollouts/libero10_pick_sweep_oracle_20_videos
LOG_DIR=$REPO/rollouts/libero10_pick_sweep_oracle_20_logs
...
cat "$REPO"/rollouts/libero10_pick_sweep_oracle_20_results.shard*.jsonl > "$OUTPUT"
