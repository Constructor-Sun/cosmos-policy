...
JOB_NAME=${JOB_NAME:-mixed_clean_camera_background_light_libero9_direct_sft}
OUT=$OUTPUT_ROOT/cosmos_policy/counterfactual_direct_sft/$JOB_NAME
...
python -m torch.distributed.run \
  ...
  job.group=counterfactual_direct_sft \
  "job.name=$JOB_NAME"
