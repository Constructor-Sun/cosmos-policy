...
PHASE8_GL_BACKEND=${PHASE8_GL_BACKEND:-egl}
PHASE8_CORRECTOR_CHECKPOINT=${PHASE8_CORRECTOR_CHECKPOINT:-}
PHASE8_CORRECTION_ALPHA=${PHASE8_CORRECTION_ALPHA:-1.0}
PHASE8_EXTRA_ARGS=${PHASE8_EXTRA_ARGS:-}

if [ -n "$PHASE8_CORRECTOR_CHECKPOINT" ]; then
    PHASE8_EXTRA_ARGS="$PHASE8_EXTRA_ARGS --corrector-checkpoint $PHASE8_CORRECTOR_CHECKPOINT --correction-alpha $PHASE8_CORRECTION_ALPHA"
fi
...
export MUJOCO_GL="$PHASE8_GL_BACKEND"
export PYOPENGL_PLATFORM="$PHASE8_GL_BACKEND"
